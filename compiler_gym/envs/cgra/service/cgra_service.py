        ...
        while True:
            ...
            for loc in range(len(self.operations[t])):
                ...
                for arrival_time in arrival_times:
                    # TODO --- note that if the problem is that the buffers
...
class Schedule(object):
    ...
    def swap(self, origin_time, origin_index, target_time, target_index, dfg, allow_invalid=True):
        ...
        if target_window_is_clear and target_time >= 0: # Dont' swap into past!
            ...
            II, _ = self.get_II(dfg)
            assert II is not None #We are tryign to preserve this invariant through the scheduling.
    ...
    def get_II(self, dfg):
        ...
        for node in dfg.bfs():
            ...
            if CGRACompileSettings['DebugGetII']:
